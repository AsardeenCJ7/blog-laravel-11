...
<div class="container-fluid ">
    ...
    <div class="row m-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="{{route('detail', ['id'=>$post->id])}}">Read More</a>
        ...
        <!-- Here I commented hard code for cards so we don't need to add like this because one card template enough using loops and make as we need -->
        <!--
          <div class="col-4 mb-4">
            <div class="card">
                <div class="card-body">
